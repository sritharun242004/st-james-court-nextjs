    ...
    <div>
      ...
      <section className="pt-52 pb-20 relative text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-6xl md:text-7xl font-playfair font-bold mb-8">Events & Celebrations</h1>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          {eventPackages.filter(pkg => pkg.id === selectedPackage).map((pkg) => (
            <div key={pkg.id} className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <div className="bg-gradient-to-r from-blue-600 to-teal-500 text-white p-3 rounded-full mr-4">
                    {pkg.icon}
                  </div>
                  <h2 className="text-4xl font-bold text-slate-900">{pkg.name}</h2>
                </div>

                <p className="text-xl text-slate-600 mb-6">{pkg.description}</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Stunning Event Venues</h2>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Our Event Planning Process</h2>
            <p className="text-xl text-slate-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-gradient-to-r from-blue-600 to-teal-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-white text-2xl font-bold">
                1
              </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Custom Proposal</h3>
              <p className="text-slate-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Event Coordination</h3>
              <p className="text-slate-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Perfect Execution</h3>
              <p className="text-slate-600">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4">Happy Clients</h2>
            <p className="text-xl text-slate-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-xl p-8 shadow-lg">
                <div className="flex items-center mb-4">
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-blue-600 to-teal-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200 flex items-center justify-center">
              <Mail className="h-5 w-5 mr-2" />
              Request Proposal
            </button>
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-slate-900 transition-all duration-200 flex items-center justify-center">
              <Phone className="h-5 w-5 mr-2" />
              Call Event Planner
            </button>
          </div>
