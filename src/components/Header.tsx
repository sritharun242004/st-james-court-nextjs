            ...
            >
              <Link href="/" className="flex items-center space-x-2">
                <img
                  ...
                  className="h-16 w-16 object-contain rounded-lg shadow-lg -ml-2"
                />
                <div>
                  <h1 className={`font-playfair font-bold text-xl ${isScrolled ? 'text-slate-900' : 'text-white'} transition-colors duration-300 ml-1`}>
                    St James Court
                  </h1>
                  <p className={`text-xs font-jost ${isScrolled ? 'text-slate-600' : 'text-white/90'} transition-colors duration-300 ml-1`}>
                    Beach Resort
                  </p>
                </div>
              </Link>
              ...
              <div className="px-6 py-6 space-y-2">
                {navigation.map((item, index) => (
                  ...
                  >
                    <Link
                      ...
                      className={`block py-3 px-4 rounded-lg font-jost font-medium transition-all duration-300 ${
                        pathname === item.href
                ...
                >
                  <Link
                    href="/booking"
                    onClick={() => setIsMenuOpen(false)}
                    className="block w-full bg-gradient-to-r from-blue-600 to-teal-500 text-white px-6 py-4 rounded-xl text-center font-jost font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
                  >
                    Book Your Stay
                  </Link>
                  ...
                  {user ? (
                    <>
                      ...
                      {user.is_admin && (
                        <Link
                          href="/admin/dashboard"
                          onClick={() => setIsMenuOpen(false)}
                          className="flex items-center gap-2 w-full bg-blue-50 text-blue-900 px-6 py-3 rounded-xl font-jost font-semibold hover:bg-blue-100 transition-colors"
                        >
                          <User className="h-5 w-5" />
                          Admin Dashboard
                        </Link>
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 w-full bg-red-50 text-red-600 px-6 py-3 rounded-xl font-jost font-semibold hover:bg-red-100 transition-colors"
                      >
                    ...
                    <Link
                      href="/login"
                      onClick={() => setIsMenuOpen(false)}
                      className="block w-full bg-slate-100 text-slate-900 px-6 py-3 rounded-xl text-center font-jost font-semibold hover:bg-slate-200 transition-colors"
                    >
                      Login / Sign Up
                    </Link>
                  )}
