    ...
    <div className="bg-slate-50">
      ...
      <section className="pt-52 pb-24 relative text-white">
        ...
        <AnimatedSection className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed text-white/80 font-jost">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-teal-100 text-blue-700 px-5 py-2 rounded-full text-sm font-semibold font-jost mb-8">
            ...
            <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-jost mb-8">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 text-center shadow-lg hover:shadow-xl transition-shadow duration-300 border border-slate-100"
              >
                ...
                <div className="text-4xl md:text-5xl font-playfair font-bold text-slate-900 mb-2">
                  {stat.value}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection direction="left">
              ...
              <p className="text-lg text-slate-600 leading-relaxed font-jost mb-6">
              ...
              <p className="text-lg text-slate-600 leading-relaxed font-jost mb-8">
            ...
            <AnimatedSection direction="right" className="relative">
              <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-10 border border-blue-100">
                <div className="text-center">
                  <div className="text-7xl md:text-8xl font-playfair font-bold bg-gradient-to-r from-blue-600 to-teal-500 bg-clip-text text-transparent mb-2">
                    25+
                  </div>
                  <p className="text-xl font-jost text-slate-600 mb-8">Years of Excellence</p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto font-jost">
          ...
          <AnimatedSection>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {amenities.map((amenity, index) => (
                <div
                  key={index}
                  className="flex items-center gap-3 bg-white px-5 py-4 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-slate-100"
                >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-10 md:p-14 text-center border border-blue-100">
            ...
            <p className="text-lg text-slate-600 font-jost max-w-2xl mx-auto mb-6">
      ...
      >
        ...
        <AnimatedSection className="relative z-10 max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-white/90 font-jost mb-8 max-w-2xl mx-auto">
