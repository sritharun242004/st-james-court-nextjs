      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection className="text-center mb-16">
            <h2 className="text-4xl font-playfair font-bold text-slate-900 mb-4">Our Venues</h2>
            <p className="text-xl text-slate-600 font-jost max-w-3xl mx-auto">
            ...
            {venues.map((venue, index) => (
              ...
              >
                ...
                <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                  ...
                  <h3 className="text-3xl md:text-4xl font-playfair font-bold text-slate-900 mb-4">
                    {venue.name}
                  </h3>
                  <p className="text-lg text-slate-600 font-jost leading-relaxed mb-8">
                    {venue.description}
                  </p>
