      ...
      >
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-in">
            St James Court
            <span className="block text-2xl sm:text-3xl md:text-4xl font-light mt-2">Beach Resort</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection direction="left">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h3 className="text-2xl font-playfair font-bold text-slate-900 mb-6">Quick Booking</h3>
                ...
                <div className="space-y-6">
                  ...
                  <Link
                    href="/booking"
                    className="w-full bg-gradient-to-r from-blue-600 to-teal-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300 inline-flex items-center justify-center"
                  >
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <AnimatedSection className="text-center mb-16">
            ...
            <h2 className="text-4xl font-playfair font-bold text-slate-900 mb-4">Resort Gallery</h2>
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <AnimatedSection direction="left">
              ...
              <h2 className="text-4xl font-playfair font-bold text-slate-900 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <AnimatedSection
                key={index}
                delay={index * 0.2}
                className="bg-gradient-to-br from-blue-50 to-teal-50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300"
              >
                <div className="flex items-center mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <AnimatedSection className="text-center mt-12" delay={0.4}>
              <Link
                href="/faq"
                className="inline-flex items-center bg-gradient-to-r from-blue-600 to-teal-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300"
              >
                View All FAQs
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <AnimatedSection direction="left">
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-600 to-teal-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center"
                  >
            ...
            <AnimatedSection direction="right">
              <div className="space-y-8">
                {/* Call Us */}
                <div className="bg-white rounded-xl shadow-lg px-8 py-5">
                  <div className="flex items-center mb-6">
